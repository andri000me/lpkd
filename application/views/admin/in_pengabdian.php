...
<script type="text/javascript">
 function validasi_input(form){
  if (form.nama.value == ""){
    alert("Nama Pengabdian masih kosong!");
    form.nama.focus();
    return (false);
  }
  if (form.datepicker.value == ""){
    alert("Tanggal Pengabdian masih kosong!");
    form.datepicker.focus();
    return (false);
  }
  if (form.satHasil.value == ""){
    alert("Satuan Hasil Pengabdian masih kosong!");
    form.satHasil.focus();
    return (false);
  }
  ...
  if (form.angkaKredit.value == ""){
    alert("Angka Kredit Pengabdian masih kosong!");
    form.angkaKredit.focus();
    return (false);
  }
  if (form.jumKredit.value == ""){
    alert("Jumlah kredit Pengabdian masih kosong!");
    form.jumKredit.focus();
    return (false);
  }
  if (form.ket.value == ""){
    alert("Keterangan Pengabdian masih kosong!");
    form.ket.focus();
    return (false);
  }
return (true);
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title"><?=$tipe?> Data Pengabdian Dosen</h3>
                    ...
                    <form method="post" enctype="multipart/form-data" onsubmit="return validasi_input(this)">
                        <table border="0" width="100%">
                            <tr>
                                ...
                                <td width="17%" valign="top"><b>Bidang Kegiatan</b></td>
                                <th>
                            ...
                            <tr>
                                ...
                                <th>
                                    <textarea name="nama" id="nama" style="width: 70%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=isset($default['namaKegiatan'])? $default['namaKegiatan'] : ""?></textarea>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                ...
                                <th><input type="text" title="Ex. 1 Januari 2018 or Semester Genap 2018/2019" placeholder="Ex. 1 Januari 2018 or Semester Genap 2018/2019" onkeypress="return hanyaHurufAngka(event)" class="form-control" id="datepicker" name="tglKegiatan" value="<?=isset($default['tglKegiatan'])? $default['tglKegiatan'] : ""?>"/>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
