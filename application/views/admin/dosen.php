...
<script>
    function hanyaHuruf(evt) {
          var charCode = (evt.which) ? evt.which : event.keyCode
           if (charCode > 32 && (charCode < 97 || charCode > 122) && (charCode < 65 || charCode > 90) && (charCode < 44 || charCode > 46) && (charCode < 48 || charCode > 57)
    ...
    <div class="row">
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form action="<?php echo site_url('auth/loadDosen'); ?>" method="post">
                        <table border="0" width="100%" >
                            <tr>
                                <th width="30%" height="20px"><input type="text" onkeypress="return hanyaHuruf(event)" name="cari" placeholder="Search Keyword..." class="form-control1"></th>
                                <th width="1%"></th>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    <div class="tools">
                                        <a class="fa fa-edit" href="<?php echo site_url('auth/edit/');  echo $row->idDosen; ?>"></a>
                                    </div>
                                </td>
                                <td align="center">
                                    <div class="tools">
                                        <!-- <a class="fa fa-trash-o" href="deleteDosen/<?php echo $row->idDosen; ?>"></a> -->
                                        <a href="#myModal" class="trash" data-id="<?php echo $row->idDosen; ?>" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php
...
$('.trash').click(function(){
    var id=$(this).data('id');
    $('#modalDelete').attr('href','<?php echo site_url('auth/deleteDosen/');?>'+id);
})
</script>
<!-- Morris.js charts -->
