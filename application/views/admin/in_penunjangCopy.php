                    ...
                    <form method="post" onsubmit="return validasi_input(this)">
                        <table border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th><input type="text" class="form-control" id="datepicker" name="tglKegiatan" value="<?=isset($default['tglKegiatan'])? $default['tglKegiatan'] : ""?>"/>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                ...
                                <th><input type="text" class="form-control" name="satHasil" id="satHasil" value="<?=isset($default['satuanHasil'])? $default['satuanHasil'] : ""?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                                <th width="17%">Jumlah Volume Kegiatan</th>
                                <th><input type="text" class="form-control" style="width: 40%;" name="jumVolKegiatan" id="jumVolKegiatan" value="<?=isset($default['jumVolumKegiatan'])? $default['jumVolumKegiatan'] : ""?>"/>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                ...
                                <th><input type="text" class="form-control" style="width: 40%;" name="angkaKredit" id="angkaKredit" value="<?=isset($default['angkaKredit'])? $default['angkaKredit'] : ""?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                                <th width="17%">Jumlah Angka Kredit</th>
                                <th><input type="text" readonly class="form-control" style="width: 40%;" name="jumKredit" id="jumKredit" value="<?=isset($default['jumAngkaKredit'])? $default['jumAngkaKredit'] : ""?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var id=$("#kegiatan").val();
            ...
            //         for(i=0; i<data.length; i++){
            //             $bag1 = data[i].idBag1;
            //             html += '<option value = '+data[i].idBag1+' <?php if(isset($default['idBag1'])||is_null($default['idBag1'])) 
            //             {
            //                 if($default['idBag1']=='+data[i].idBag1+') 
            //                 {
            //                     echo "selected";
            //                 };
            //             };
            //             ?>><?php echo '+data[i].namaBag1+' ?></option>';
            //             // html += '<option value = '+data[i].idBag1+' <?=isset($default['idBag1']) ? (($default['idBag1']=='+data[i].idBag1+')? 'selected="selected"' : "") : "";?>>'+data[i].namaBag1 +'</option>';
            //         }
            //         $('#subkategori').html(html);
            //     }
            // });
