        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title">Data Pendidikan & Pengajaran Semua Dosen</h3> 
                    ...
                    <div class="box-footer clearfix">
                        <!-- <form action="<?php echo site_url('auth/inDosen') ?>" method="post"> -->
                            <a href="<?php echo site_url('auth/laporanRekapPengajaran') ?>" target="_blank" class="btn btn-sm btn-info btn-flat pull-left"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print Semua Data Pendidikan & Pengajaran&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                        <!-- </form> -->
                            <a href="<?php echo site_url('auth/pengajaran') ?>" class="btn btn-sm btn-default btn-flat pull-right"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Data Pendidikan & Pengajaran Saya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form action="<?php echo site_url('auth/pengajaranAdmin'); ?>" method="post">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    <div class="tools">
                                        <a class="fa fa-edit" href="<?php echo site_url('auth/editPengajaranAdmin/'); echo $row->idPengajaran; ?>"></a>
                                    </div>
                                </td>
                                <td align="center">
                                    <div class="tools">
