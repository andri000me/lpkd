        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title">Data Pendidikan & Pengajaran <?php print $this->session->userdata('nama'); ?></h3> 
                    ...
                    <div class="box-footer clearfix">
                        <!-- <form action="<?php echo site_url('auth/inDosen') ?>" method="post"> -->
                            <a href="<?php echo site_url('auth/laporanPengajaran') ?>" target="_blank" class="btn btn-sm btn-info btn-flat pull-left"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print Data Pendidikan & Pengajaran Saya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                        <!-- </form> -->
                            <a href="<?php echo site_url('auth/pengajaranAdmin') ?>" class="btn btn-sm btn-default btn-flat pull-right"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lihat Semua Pendidikan & Pengajaran Dosen&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form action="<?php echo site_url('auth/pengajaran'); ?>" method="post">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row->tglPengajaran;?></td>
                                <td><?php echo $row->satuanHasil; ?></td>
                                <td align="center"><?php echo $row->jumVolumKegiatan; ?></td>
                                <td align="center"><?php echo $row->angkaKredit; ?></td>
                                <td align="center"><?php echo $row->jumAngkaKredit; ?></td>
                                <td>
                                    <?php echo $row->ket; ?><br/>
                                    <?php 
                                    $teman = "andi";
                                    if($row->file == ""){
                                        ...
                                        <a href="<?php echo site_url('auth/lakukan_download/'); echo $row->file; ?>" target="_blank"><i class="fa fa-paperclip"></i>Unduh Berkas</a>
                                    <?php 
                                    }?>
                                </td>
                                <td align="center">
                                    <div class="tools">
                                        <a class="fa fa-edit" href="<?php echo site_url('auth/editPengajaran/'); echo $row->idPengajaran; ?>"></a>
                                    </div>
                                </td>
                                <td align="center">
                                    <div class="tools">
                                        <!-- <a class="fa fa-trash-o" href="deletePengajaran/<?php echo $row->idPengajaran; ?>"></a> -->
                                        <a href="#myModal" class="trash" data-id="<?php echo $row->idPengajaran; ?>" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php
...
$('.trash').click(function(){
    var id=$(this).data('id');
    $('#modalDelete').attr('href','<?php echo site_url('auth/deletePengajaran/');?>'+id);
})
</script>
<!-- Morris.js charts -->
