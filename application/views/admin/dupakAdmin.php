                ...
                <div class="box-header">
                    ...
                    <div class="box-footer clearfix">
                        <!-- <form action="<?php echo site_url('auth/inDosen') ?>" method="post"> -->
                            <!-- <a href="#" class="btn btn-sm btn-info btn-flat pull-left"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print Pengajaran Dosen&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a> -->
                        <!-- </form> -->
                            
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form action="<?php echo site_url('auth/dupakAdmin'); ?>" method="post">
                        <table border="0" width="100%" >
                            <tr>
                                ...
                                <th><a href="<?php echo site_url('auth/dupak') ?>" class="btn btn-sm btn-default btn-flat pull-right"><b><i class="fa fa-file"></i> Lihat Data Dupak Saya</b></a></th>
                            </tr>
                        </table>
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    <div class="tools">
                                        <a class="fa fa-edit" href="<?php echo site_url('auth/editDupak/'); echo $row->id; ?>"></a>
                                    </div>
                                </td>
                                <td align="center">
                                    <div class="tools">
                                        <!-- <a class="fa fa-trash-o" href="deleteDupak/<?php echo $row->id; ?>"></a> -->
