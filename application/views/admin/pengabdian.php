        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title">Data Pengabdian <?php print $this->session->userdata('nama'); ?></h3> 
                    ...
                    <div class="box-footer clearfix">
                        <!-- <form action="<?php echo site_url('auth/inDosen') ?>" method="post"> -->
                            <a href="<?php echo site_url('auth/laporanPengabdian') ?>" target="_blank" class="btn btn-sm btn-info btn-flat pull-left"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print Data Pengabdian Saya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                        <!-- </form> -->
                            <a href="<?php echo site_url('auth/pengabdianAdmin') ?>" class="btn btn-sm btn-default btn-flat pull-right"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lihat Semua Pengabdian Dosen&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form action="<?php echo site_url('auth/pengabdian'); ?>" method="post">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    <div class="tools">
                                        <a class="fa fa-edit" href="<?php echo site_url('auth/editPengabdian/'); echo $row->idPengabdian; ?>"></a>
                                    </div>
                                </td>
                                <td align="center">
                                    <div class="tools">
...
$('.trash').click(function(){
    var id=$(this).data('id');
    $('#modalDelete').attr('href','<?php echo site_url('auth/deletePengabdian/');?>'+id);
})
</script>
<!-- Morris.js charts -->
