...
<script>
    ...
    function hanyaAngka1(evt) {
          var charCode = (evt.which) ? evt.which : event.keyCode
           if (charCode > 31 && (charCode < 48 || charCode > 57)&& (charCode < 45 || charCode > 45)&& (charCode < 97 || charCode > 122) && (charCode < 65 || charCode > 90))
...
<script type="text/javascript">
 function validasi_input(form){
  if (form.judul.value == ""){
    alert("Judul penelitian masih kosong!");
    form.judul.focus();
    return (false);
  }
  if (form.issn.value == ""){
    alert("No ISSN masih kosong!");
    form.issn.focus();
    return (false);
  }
  if (form.tglPenelitian.value == ""){
    alert("Tanggal Penelitian masih kosong!");
    form.tglPenelitian.focus();
    return (false);
  }
  if (form.satHasil.value == ""){
    alert("Satuan Hasil penelitian masih kosong!");
    form.satHasil.focus();
    return (false);
  }
  ...
  if (form.angkaKredit.value == ""){
    alert("Angka Kredit penelitaian masih kosong!");
    form.angkaKredit.focus();
    return (false);
  }
  if (form.jumKredit.value == ""){
    alert("Jumlah kredit penelitian masih kosong!");
    form.jumKredit.focus();
    return (false);
  }
  if (form.ket.value == ""){
    alert("Keterangan penelitian masih kosong!");
    form.ket.focus();
    return (false);
  }
return (true);
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title"><?=$tipe?> Data Penelitian Dosen</h3>
                    ...
                    <form method="post" enctype="multipart/form-data" onsubmit="return validasi_input(this)">
                        <table border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td width="17%" valign="top"><b>Judul Penelitian</b></td>
                                <th>
                                    <textarea placeholder="Kegiatan Penelitian" name="judul" id="judul" style="width: 70%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=isset($default['judul'])? $default['judul'] : ""?></textarea>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                                <th width="17%">ISSN</th>
                                <th><input type="text" onkeypress="return hanyaAngka1(event)" class="form-control" name="issn" id="issn" value="<?=isset($default['issn'])? $default['issn'] : ""?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                                <th width="17%">Masa Penelitian</th>
                                <th><input type="text" title="Ex. 1 Januari 2018 or Semester Genap 2018/2019" placeholder="Ex. 1 Januari 2018 or Semester Genap 2018/2019" onkeypress="return hanyaHurufAngka(event)"class="form-control" name="tglPenelitian" id="tglPenelitian" value="<?=isset($default['tglPenelitian'])? $default['tglPenelitian'] : ""?>"/>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th><input type="text" onkeypress="return hanyaAngka(event)" class="form-control" style="width: 40%;" name="volKegiatan" id="volKegiatan" value="<?=isset($default['volumeKegiatan'])? $default['volumeKegiatan'] : "0"?>"/>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
