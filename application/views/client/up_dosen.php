                    ...
                    <form action="<?php echo site_url('auth/inDosen') ?>" method="post">
                        <table border="0" width="100%" >
                            ...
                            <tr>
                                ...
                                <th>
                                    <select class="form-control" name="status" value="<?=isset($default['statusDosen'])? $default['statusDosen'] : ""?>">
                                        <option value="Dosen Tetap Yayasan">Dosen Tetap Yayasan</option>
                                        <option value="Dosen PNS DPK">Dosen PNS DPK</option>
                                    </select>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                ...
                                <th>
                                    <select class="form-control" name="jabatan" value="<?=isset($default['jabatan'])? $default['jabatan'] : ""?>">
                            ...
                            <tr>
                                ...
                                <th>
                                    <select class="form-control" name="bagian" value="<?=isset($default['bagian'])? $default['bagian'] : ""?>">
