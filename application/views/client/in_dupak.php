...
<script>
    ...
    function hanyaHurufAngka(evt) {
          var charCode = (evt.which) ? evt.which : event.keyCode
           if (charCode > 32 && (charCode < 45 || charCode > 45) && (charCode < 97 || charCode > 122) && (charCode < 65 || charCode > 90) && (charCode < 47 || charCode > 57))
 
            return false;
          return true;
    }
    function hanyaHurufAngka1(evt) {
          var charCode = (evt.which) ? evt.which : event.keyCode
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title"><?=$tipe?> Data Pengajaran Dosen</h3>
                    ...
                    <form method="post" onsubmit="return validasi_input(this)">
                        <table border="0" width="100%">
                            <tr>
                                ...
                                <th width="17%">Pendidikan Yang di Perhitungkan</th>
                                <th colspan="3"><input type="text" onkeypress="return hanyaHurufAngka1(event)" class="form-control" name="pend" value="<?=isset($default['pendDiperhitungkan'])? $default['pendDiperhitungkan'] : ""?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                                ...
                                <th><input type="text" style="width:49%;" onkeypress="return hanyaHurufAngka(event)" class="form-control" name="tmtAkad" value="<?=isset($default['TMTAkademik'])? $default['TMTAkademik'] : "--"?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                                <th width="17%">Pangkat/TMT</th>
                                <th><input type="text" class="form-control" style="width:98%;" name="pangkat" value="<?=isset($default['pangkat'])? $default['pangkat'] : "--"?>"/>
                                </th>
                                <td width="2%" align="center"><font size="6">/</font></td>
                                <th><input type="text" style="width:49%;" onkeypress="return hanyaHurufAngka(event)" class="form-control" name="tmtPangkat" value="<?=isset($default['TMTPangkat'])? $default['TMTPangkat'] : "--"?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                                <th width="17%">Masa Gol Lama</th>
                                <th colspan="3"><input type="text" onkeypress="return hanyaHurufAngka(event)" class="form-control" name="golLama" value="<?=isset($default['masaGolLama'])? $default['masaGolLama'] : "--"?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                                <th width="17%">Masa Gol Baru/TMT</th>
                                <th><input type="text" class="form-control" style="width:98%;" name="golBaru" value="<?=isset($default['masaGolBaru'])? $default['masaGolBaru'] : "--"?>"/>
                                </th>
                                <td width="2%" align="center"><font size="6">/</font></td>
                                <th><input type="text" style="width:49%;" onkeypress="return hanyaHurufAngka(event)" class="form-control" name="tmtGolBaru" value="<?=isset($default['TMTGolBaru'])? $default['TMTGolBaru'] : "--"?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                            ...
                            <tr>
                                ...
                                <th colspan="3"><input type="text" onkeypress="return hanyaHuruf(event)" class="form-control" name="namaBidang" value="<?=isset($default['namaBidang'])? $default['namaBidang'] : ""?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
