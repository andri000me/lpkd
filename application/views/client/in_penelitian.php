                    ...
                    <form method="post" onsubmit="return validasi_input(this)">
                        <table border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th>
                                    <textarea placeholder="Kegiatan Penelitian" onkeypress="return hanyaHurufAngka(event)" name="judul" id="judul" style="width: 70%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=isset($default['judul'])? $default['judul'] : ""?></textarea>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th><input type="text" placeholder="Ex. 1 Januari 2018 or Semester Genap 2018/2019" onkeypress="return hanyaHurufAngka(event)" class="form-control" name="tglPenelitian" id="tglPenelitian" value="<?=isset($default['tglPenelitian'])? $default['tglPenelitian'] : ""?>"/>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
