            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <!-- </form> -->
                            <a href="<?php echo site_url('auth/inPengajaranClient') ?>" class="btn btn-sm btn-default btn-flat pull-right"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-plus"></i> Add item&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form action="<?php echo site_url('auth/pengajaranClient'); ?>" method="post">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    <div class="tools">
                                        <a class="fa fa-edit" href="<?php echo site_url('auth/editPengajaranClient/'); echo $row->idPengajaran; ?>"></a>
                                    </div>
                                </td>
                                <td align="center">
                                    <div class="tools">
                                        <!-- <a class="fa fa-trash-o" href="deletePengajaranClient/<?php echo $row->idPengajaran; ?>"></a> -->
...
$('.trash').click(function(){
    var id=$(this).data('id');
    $('#modalDelete').attr('href','<?php echo site_url('auth/deletePengajaranClient/');?>'+id);
})
</script>
<!-- Morris.js charts -->
