                    ...
                    <form method="post"  onsubmit="return validasi_input(this)">
                        <table border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th>
                                    <textarea placeholder="Judul kegiatan pend & pengajaran" name="judul" style="width: 70%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=isset($default['uraian'])? $default['uraian'] : ""?></textarea>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                ...
                                <th><input type="text" placeholder="Ex. 1 Januari 2018 or Semester Genap 2018/2019" onkeypress="return hanyaHurufAngka(event)" class="form-control" name="tglPenelitian" value="<?=isset($default['tglPengajaran'])? $default['tglPengajaran'] : ""?>"/>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                ...
                                <th><input type="text" onkeypress="return hanyaHurufAngka(event)" class="form-control" name="satHasil" value="<?=isset($default['satuanHasil'])? $default['satuanHasil'] : ""?>"/></th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
                                <th width="15%" height="50px"></th>
                            ...
                            <tr>
                                ...
                                <th>
                                    <textarea placeholder="Keterangan" name="ket" style="width: 70%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?=isset($default['ket'])? $default['ket'] : ""?></textarea>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
