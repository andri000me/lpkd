                    ...
                    <form method="post" onsubmit="return validasi_input(this)">
                        <table border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th><input type="text" placeholder="Ex. 1 Januari 2018 or Semester Genap 2018/2019" onkeypress="return hanyaHurufAngka(event)" class="form-control" id="datepicker" name="tglKegiatan" value="<?=isset($default['tglKegiatan'])? $default['tglKegiatan'] : ""?>"/>
                                </th>
                                <th width="15%"></th>
                            </tr>
                            <tr>
