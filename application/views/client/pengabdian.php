            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <!-- </form> -->
                            <a href="<?php echo site_url('auth/inPengabdianClient') ?>" class="btn btn-sm btn-default btn-flat pull-right"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-plus"></i> Add item&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form action="<?php echo site_url('auth/pengabdianClient'); ?>" method="post">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    <div class="tools">
                                        <a class="fa fa-edit" href="<?php echo site_url('auth/editPengabdianClient/'); echo $row->idPengabdian; ?>"></a>
                                    </div>
                                </td>
                                <td align="center">
                                    <div class="tools">
                                        <!-- <a class="fa fa-trash-o" href="deletePengabdianClient/<?php echo $row->idPengabdian; ?>"></a> -->
...
$('.trash').click(function(){
    var id=$(this).data('id');
    $('#modalDelete').attr('href','<?php echo site_url('auth/deletePengabdianClient/');?>'+id);
})
</script>
<!-- Morris.js charts -->
