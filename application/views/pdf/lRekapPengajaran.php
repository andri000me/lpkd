...
$pdf->Cell(270,5,'PELAKSANAAN PENGAJARAN TUGAS DOSEN',0,1,'C');
$pdf->ln(7);
$pdf->SetFont('helvetica','B',8);
$pdf->SetWidths(array(7,30,47,50,20,20,16,15,15,50));
    $pdf->Row1(array(
                array("No","C"),
                array("Nama","C"),
                array("Komponen Pengajaran","C"),
