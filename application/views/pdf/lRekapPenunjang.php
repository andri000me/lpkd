...
$pdf->Cell(270,5,'PELAKSANAAN PENUNJANG TUGAS DOSEN',0,1,'C');
$pdf->ln(7);
...
$pdf->SetFont('helvetica','',8);
    $pdf->Row1(array(
                array($no,"C"),
                array($data->nama,"L"),
                array($data->namaBagian." Sebagai ".$data->namaBag1,"L"),
                array($data->namaKegiatan,"L"),
                array($data->tglKegiatan,"C"),
                array($data->satuanHasil,"C"),
                array($data->jumVolumKegiatan,"C"),
